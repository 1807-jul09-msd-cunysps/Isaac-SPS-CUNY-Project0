...
namespace PhoneDirectoryTest
{
    ...
    public class PhoneDirectoryTest
    {
        ...
        public void AddContactTest()
        {
            ...
            Contact contact = new Contact("John", "Smith", 32, new List<Address>(), 0, new List<Email>(), new List<Phone>());
        ...
        public void SearchContactsTest()
        {
            ...
            using(var connection = new SqlConnection("Data Source=robodex.database.windows.net;Initial Catalog=RoboDex;Persist Security Info=True;User ID=isaac;Password=qe%8KQ^mrjJe^zq75JmPe$xa2tWFxH"))
            {
                ...
                for (int i = 0; i < 1; i++)
                {
                    ...
                    contact = new Contact("John", "Smith", 32, new List<Address>(), 0, new List<Email>(), new List<Phone>());
        ...
        public void UpdateContactTest()
        {
            ...
            Contact contactInMemory = new Contact("John", "Smith", 32, new List<Address>(), 0, new List<Email>(), new List<Phone>());
